...
?>
            ...
            <div class="p-1 bg-info bg-opacity-25">
		...
		if(!empty($valor)){
            ...
            <div class="alert alert-info">
                        <div class="container">
                            ...
                            <a class="btn btn-outline-info text-black btn-primary" href="modiUser.php?id=<?php echo $rowBuscar['id']; ?>">Editar</a>
                            
                            <i class="material-icons text-black">Usuario: <?php echo $rowBuscar['usuario']; ?></i>
                            
                            <a class="btn btn-outline-info text-black btn-primary" href="../FuncionesInfo/EliminarUser.php?id=<?php echo $rowBuscar['id']; ?>">Eliminar</a>
		...
		while($rowPoster=$resultPost->fetch_array(MYSQLI_ASSOC)) 
                {
                        ?>
                                <div class="p-3">
                <a class="btn btn-outline-info text-black btn-primary" href="modiUser.php?id=<?php echo $rowPoster['id']; ?>">Editar</a>
                <i class="material-icons text-black"><?php echo $rowPoster['usuario']; ?></i>
                <a class="btn btn-outline-info text-black btn-primary" class="liNavR" href="../FuncionesInfo/EliminarUser.php?id=<?php echo $rowPoster['id']; ?>">Eliminar</a>
                                </div>
